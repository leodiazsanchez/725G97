...
public class AVLTreeNode<T extends Comparable<T>> {
	...
	public AVLTreeNode<T> insert(T data) {
		...
		int bf = getBalance(this);

		//Left Left Case
		if (bf > 1 && data.compareTo(left.element) < 0){
			return singleRotationWithLeftChild(this);
		}

		// Right Right Case
		if (bf < -1 && data.compareTo(right.element) > 0){
	 ...
	 *
	 * @param n - AVLTreeNode for which to get the balance factor.
	 */
